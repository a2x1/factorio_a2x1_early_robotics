...
data.raw.technology["circuit-network"].unit.time = 10 --15
data.raw.technology["circuit-network"].unit.count = 10 --100
...
data.raw.technology["robotics"].unit.time = 10 --30
data.raw.technology["robotics"].unit.count = 10 --75
...
data.raw.technology["construction-robotics"].unit.time = 10 --30
data.raw.technology["construction-robotics"].unit.count = 10 --100
...
data.raw.technology["logistic-robotics"].unit.time = 10 --30
data.raw.technology["logistic-robotics"].unit.count = 10 --250
...
data.raw.technology["logistic-system"].unit.time = 10 --30
data.raw.technology["logistic-system"].unit.count = 10 --500
